...
// Ryan: A better approach here would be to create a Base Array class
// that we can inherit from to avoid the problem with the Fixed Array
// class inheriting our resize method.
// Fixed: Created Base_Array class; Array now inherits from it.
