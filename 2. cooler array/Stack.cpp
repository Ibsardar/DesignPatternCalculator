...
Stack <T>::~Stack (void) {
    ...
    // Ryan: Is this necessary here?
    // Fixed: Since I 'data_' is a pointer to an Array, yes, the
    // freeing of the memory of the Array pointer is necessary.
    // If 'data_' is not a pointer, (i.e. on the stack instead of the heap)
